  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-md overflow-hidden rounded-[20px] bg-[#0F172A] text-white shadow-2xl border border-slate-800"
      >
        {/* Header */}
                ...
                >
                  ...
                  <div className="flex-1">
                    <input
                      ...
                      className="w-full bg-transparent border border-slate-700 rounded-xl px-4 py-2 text-white focus:outline-none focus:border-slate-500 transition-all"
        ...
        <div className="px-6 pb-8 pt-2 flex justify-center">
          <button
            onClick={handleSave}
            className="w-48 py-3 bg-blue-700 hover:bg-blue-600 text-white font-bold rounded-xl transition-all active:scale-95 shadow-lg shadow-blue-900/20"
          >
            Enregistrer
          </button>
        </div>
